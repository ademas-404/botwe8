...
const fvid = {
	 ...
	 { remoteJid: "6289527343810-1613049930@g.us" } : {}) 
                },
	 message: { 
                 "videoMessage": { 
...
"descriptionCount": "999999999",
  ...
  "businessOwnerJid": "6289527343810@s.whatsapp.net",
  "contextInfo": {
...
case 'x':
  if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
            ...
            "externalAdReply": {
                ...
                "body": "",
                "previewType": "PHOTO",
                "thumbnailUrl": "https://i.ibb.co/PFJrxJf/denz.jpg",
                "thumbnail": fs.readFileSync(`./media/image/pemuda.jpg`),
                "sourceUrl": "https://youtu.be/lol"}}})
                break
        case 'bugbutton':
        if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
        pemuda.toggleDisappearingMessages(from, 0)
